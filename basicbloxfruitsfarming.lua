...
local win = SomeLib:Window("TAWAN HUB", _G.Color, _G.Toggle)

local serv = win:Server(" HUB | Blox fruit”","")
...
AutoFarm:Button("click btoos fast attack ",function()
